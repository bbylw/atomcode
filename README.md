...
<p align="center">
  <a href="https://atomgit.com/atomgit_atomcode/atomcode/blob/main/README.md">English</a> · 简体中文
</p>
...
完整设计与当前边界见 [权限模型](https://atomgit.com/atomgit_atomcode/atomcode/blob/main/docs/security/permission-model.md)。

### 隐私

- 📊 匿名遥测（默认开启，可关闭）— 详见 [docs/telemetry.md](https://atomgit.com/atomgit_atomcode/atomcode/blob/main/docs/telemetry.md)
...
MIT License。详见 [LICENSE](https://atomgit.com/atomgit_atomcode/atomcode/blob/main/LICENSE)。
